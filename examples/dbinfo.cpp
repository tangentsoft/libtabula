...
// Print out the Libtabula server version
static void
show_mysql_version(libtabula::Connection& con)
{
	separator(cout, "");
    cout << "Libtabula version: " << con.client_version();
}


// Print out the names of all the databases managed by the server
static void
show_databases(libtabula::Connection& con)
{
	libtabula::Query query = con.query("show databases");
	separator(cout, query.str());
	libtabula::StoreQueryResult res = query.store();

	cout << "Databases found: " << res.size();
	cout.setf(ios::left);
	libtabula::StoreQueryResult::iterator rit;
...
static void
show_table_info(libtabula::Connection& con, const vector<string>& tables)
{
...
static void
show_tables(libtabula::Connection& con)
{
	libtabula::Query query = con.query("show tables");
	separator(cout, query.str());
	libtabula::StoreQueryResult res = query.store();
