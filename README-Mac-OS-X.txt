...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    - The simplest option is to download the libtabula server DMG from
    ...
    - If you really only want the C API development files, libtabula offers
    ...
    - If you use Fink, you can install the C API files with:
      ...
      If you also want a local libtabula server, say this instead:
