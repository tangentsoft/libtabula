...
#if !defined(LIBTABULA_CMDLINE_H)
#define LIBTABULA_CMDLINE_H
...
namespace libtabula {
	...
	class LIBTABULA_EXPORT CommandLineBase
	{
	public:
		//// Public types
	...
	/// \brief Stuff related to libtabula examples specifically
	namespace examples {
		/// \brief Name of examples' DB
		extern LIBTABULA_EXPORT const char* db_name;

		/// \brief Command line parsing mechanism for ../examples/*.cpp
		class LIBTABULA_EXPORT CommandLine : public CommandLineBase
		{
		public:
			//// Public interface
			/// \brief Constructor
	...
	} // end namespace libtabula::examples


	/// \brief Stuff specific to the ssqlsxlat tool
	namespace ssqlsxlat {
		/// \brief Command line parser for libtabula's ssqlsxlat tool
		class LIBTABULA_EXPORT CommandLine : public CommandLineBase
		{
		public:
			//// Public types
	...
	} // end namespace libtabula::ssqlsxlat
} // end namespace libtabula

#endif // !defined(LIBTABULA_CMDLINE_H)
