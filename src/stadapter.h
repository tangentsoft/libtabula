...
#if !defined(LIBTABULA_SQL_TYPE_ADAPTER_H)
#define LIBTABULA_SQL_TYPE_ADAPTER_H
...
public:
	...
	/// should be using libtabula::tiny_int instead.  It avoids the
...
#endif // !defined(LIBTABULA_SQL_TYPE_ADAPTER_H)
