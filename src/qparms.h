...
#ifndef LIBTABULA_QPARMS_H
#define LIBTABULA_QPARMS_H
...
/// template queries. 
class LIBTABULA_EXPORT SQLQueryParms : public std::vector<SQLTypeAdapter>
{
public:
...
/// template also have to be stored somewhere.  libtabula chooses to
...
#endif // !defined(LIBTABULA_QPARMS_H)
