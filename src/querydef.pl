...
#ifndef LIBTABULA_QUERYDEF_H
#define LIBTABULA_QUERYDEF_H

#define LIBTABULA_TQUERY_MAX_PARAMETERS $max_parameters
...
## That's all, folks!
print OUT "#endif // !defined(LIBTABULA_QUERYDEF_H)\n";
