...
#if !defined(LIBTABULA_DATETIME_H)
#define LIBTABULA_DATETIME_H
...
class LIBTABULA_EXPORT DateTime : public Comparable<DateTime>
{
public:
	...
	/// member function: std::string, libtabula::String...
	///
...
LIBTABULA_EXPORT std::ostream& operator <<(std::ostream& os,
		const DateTime& dt);
...
class LIBTABULA_EXPORT Date : public Comparable<Date>
{
public:
	/// \brief Default constructor
...
class LIBTABULA_EXPORT Time : public Comparable<Time>
{
public:
	/// \brief Default constructor
...
#endif // !defined(LIBTABULA_DATETIME_H)
