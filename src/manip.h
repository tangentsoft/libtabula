...
/// key Libtabula data types, since we know when to do automatic quoting
...
#ifndef LIBTABULA_MANIP_H
#define LIBTABULA_MANIP_H
...
LIBTABULA_EXPORT SQLQueryParms& operator <<(quote_type2 p,
		SQLTypeAdapter& in);
...
LIBTABULA_EXPORT std::ostream& operator <<(quote_type1 o,
...
LIBTABULA_EXPORT SQLQueryParms&
operator <<(quote_only_type2 p, SQLTypeAdapter& in);


LIBTABULA_EXPORT std::ostream&
