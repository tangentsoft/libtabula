...
#if !defined(LIBTABULA_SSX_PARSEV2_H)
#define LIBTABULA_SSX_PARSEV2_H
...
public:
	...
	public:
		...
		public:
			...
			///
			/// This list is shorter than what we support in libtabula's
			...
			/// libtabula.  We map SQL types to one of these values as
			/// best we can.
			///
	...
	class FileException : public libtabula::Exception
	{
	public:
		/// \brief Constructor
		///
	...
	class ParseException : public libtabula::Exception
	{
	public:
		/// \brief Constructor
		///
...
#endif // !defined(LIBTABULA_SSX_PARSEV2_H)
