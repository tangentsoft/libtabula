...
/// is a stand-in for the libtabula::Transaction class and defaults to 
...
#if !defined(LIBTABULA_INSERTPOLICY_H)
#define LIBTABULA_INSERTPOLICY_H
...
class LIBTABULA_EXPORT RowCountInsertPolicy
{
public:
	/// \brief Constructor
...
/// passed in.
template <class AccessController = Transaction>
class LIBTABULA_EXPORT SizeThresholdInsertPolicy
{
public:
	/// \brief Constructor
...
template <class AccessController = Transaction>
class LIBTABULA_EXPORT MaxPacketInsertPolicy
{
public:
	/// \brief Constructor
	///
...
#endif // !defined(LIBTABULA_INSERTPOLICY_H)
