...
const MySQLFieldType::sql_type_info MySQLFieldType::types[] = {
	...
	sql_type_info("TINYINT UNSIGNED NOT NULL", typeid(sql_tinyint_unsigned),
			MYSQL_TYPE_TINY,
			MySQLFieldTypeInfo::tf_unsigned),
	...
	sql_type_info("MEDIUMINT NOT NULL", typeid(sql_mediumint),
			MYSQL_TYPE_INT24, MySQLFieldTypeInfo::tf_unsigned),
	...
	sql_type_info("NULL NULL", typeid(Null<void>),
			MYSQL_TYPE_NULL, MySQLFieldTypeInfo::tf_null),
	...
	sql_type_info("MEDIUMINT NULL", typeid(Null<sql_mediumint>),
			MYSQL_TYPE_INT24, MySQLFieldTypeInfo::tf_null),
	...
	sql_type_info("TINYBLOB NULL", typeid(Null<sql_tinyblob>),
			MYSQL_TYPE_TINY_BLOB, MySQLFieldTypeInfo::tf_null),
	sql_type_info("MEDIUMBLOB NULL", typeid(Null<sql_mediumblob>),
			MYSQL_TYPE_MEDIUM_BLOB, MySQLFieldTypeInfo::tf_null),
	sql_type_info("LONGBLOB NULL", typeid(Null<sql_longblob>),
			MYSQL_TYPE_LONG_BLOB, MySQLFieldTypeInfo::tf_null),
...
MySQLFieldTypeInfo_lookup::MySQLFieldTypeInfo_lookup(
